...
* Configuration
** ubuntu
key swap mapping for GNOME map layer
#+begin_src sh
...
- 'altwin:swap_alt_win': in alt and win category do the action:: swap the alt and win, where win can be Option in MacOS style
-  l only for left
- 'ctrl:swapcaps': in ctal category do the action:: swap caps with ctrl
